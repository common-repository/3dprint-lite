...
?>
	<div id="p3dlite-stellarnav-coating" <?php if ($settings['show_coatings']!='on') echo 'style="display:none;"';?> class="stellarnav p3dlite-info">
		<div style="display:none;" class="menubtn"><?php esc_html_e( 'Coating', '3dprint-lite' );?></div>
		<ul class="nav">
			<li class="mega"><a id="p3dlite-coating-name" class="dd-title" href="javascript:void(0)"><?php esc_html_e( 'Coating', '3dprint-lite' );?></a>
				<ul>
<?php
